...
def iterate_x(x, timestep):
    ...
    ret[3] = x[3] + x[12] * timestep#+ acc[0] * timestep #+ x[12] * timestep#
    ret[4] = x[4] + x[13] * timestep#+ acc[1] * timestep #+ x[13] * timestep#
    ret[5] = x[5] + (x[14]- 9.77) * timestep#+(acc[2]-9.81) * timestep #+ (x[14]-9.81) * timestep#
    #print(ret[3:6])
    #print(timestep)
    # O,w
    ...
    # a
    ret[12] = x[12]   #+ w_dot[0] * timestep
    ret[13] = x[13] #+ w_dot[1] * timestep
    ret[14] = x[14] #+ w_dot[2] * timestep
    return ret
...
def debug_cb(data):
    ...
    #print(get_estimate_state)
    #print(get_estimate_state.data[12:15])
    #acc_ukf = np.array([data[1], data[2], data[3]])
